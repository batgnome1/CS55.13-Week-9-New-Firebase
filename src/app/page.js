// Import the ModuleListings component that will display the list of modules
import ModuleListings from "@/src/components/ModuleListings.jsx";
// Import the getModules function to fetch module data from Firestore
...
/**
 * Home page component - the main landing page for the module app
 * This is an async server component that fetches module data on the server
 ...
 * @returns {JSX.Element} The rendered home page with module listings
 */
export default async function Home(props) {
  // Extract search parameters from the URL (e.g., ?city=London&category=Indian&sort=Review)
  // These parameters are used for filtering modules on the server-side
  ...
  // Fetch modules from Firestore using the server app and search parameters
  ...
  // Render the main page with module listings
  return (
    <main className="main__home">
      <ModuleListings
        initialModules={modules} // Pass the fetched modules as initial data
